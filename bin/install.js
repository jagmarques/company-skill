...
// check-contracts.js, check-findings.js). check.sh and test files stay in the
// repo only and are not needed at install time.
const INSTALL_SCRIPTS = ['codegraph.js', 'check-contracts.js', 'check-findings.js'];
